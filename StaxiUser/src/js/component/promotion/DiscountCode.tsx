...
import { Text, HttpView, UserUtils } from '../../../module';
                ...
                <TouchableOpacity
                    ...
                    <View style={styles.infocontent}>
                        <View style={styles.money}>
                            ...
                            <Text textStyle={styles.price} text={UserUtils.formatMoney(item.money.value) + " đ"} />
                        </View>
                        {
...
const styles = StyleSheet.create({
    ...
    container: {
        borderColor: '#297FC8',
        borderWidth: 1,
        marginTop: dimensChild.promotion_item_padding,
        backgroundColor: colors.colorWhiteFull
    },
    hdcontainer: {
        backgroundColor: '#a2e0ff',
        flexDirection: 'row',
        padding: dimensChild.register_margin_txtPhone,
        justifyContent: 'center',
        alignItems: 'center'
    },
    hdtitle: {
    ...
    hdstatus: {
        ...
        padding: dimensChild.promotion_item_padding_status
    },
    content: {
    ...
    secondinfo: {
        color: 'black',
        fontSize: 13,
        marginBottom: dimensChild.promotion_item_padding_status,
    },
    thirdinfo: {
        textAlign: 'center',
        fontSize: 12,
